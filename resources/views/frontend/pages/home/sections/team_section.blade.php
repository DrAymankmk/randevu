		...
		<div class="row justify-content-center">
			<div class="col-xl-6 col-xxl-5">
				<div class="title-area text-center pe-xl-5 ps-xl-5">
					<span class="sub-title text-anime-style-2">medical
						experts</span>
					<h2 class="sec-title text-anime-style-3">Skilled <span
							class="fw-normal">Professionals</span>
						at
						Medova</h2>
				</div>
			</div>
					...
					<div class="box-content">
						<div>
							<h3 class="box-title"><a
									href="doctor-details.html">Dr.
									Julia Jany</a></h3>
							<span class="team-desig">Gynecology
								Specialist</span>
						</div>
				...
				<div class="th-team team-card">
					...
					<div class="box-content">
						<div>
							...
							<span class="team-desig">Neurology
								Specialist</span>
						</div>
						<div class="team-social">
							<div class="icon-btn"><i
					...
					<div class="box-content">
						<div>
							<h3 class="box-title"><a
									href="doctor-details.html">Dr.
									Alex Smith</a></h3>
							<span class="team-desig">Cardiology
								Specialist</span>
						</div>
						<div class="team-social">
							<div class="icon-btn"><i
