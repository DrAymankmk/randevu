<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="tab-content pt-3" id="languageTabsContent">
            @foreach($languages as $index => $lang)
            @php
                $translation = isset($section) ? $section->translations->where('locale', $lang->code)->first() : null;
            @endphp
            <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" 
                ...
                @include('backend.components.rich-text-editor', [
                    ...
                    'value' => old('translations.'.$lang->code.'.description', $translation->description ?? ''),
                ...
                @include('backend.components.image-upload', [
                    ...
                    'label' => __('Main Image'),
                    'existingImage' => isset($section) ? $section->getFirstMediaUrl('images_' . $lang->code) : null
                ])
            </div>
            @endforeach
        </div>
