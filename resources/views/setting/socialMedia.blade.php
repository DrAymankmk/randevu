...
@section('content')
                    ...
                    <div class="col">
                        <div class="page-header-left">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">اضافه بيانات التواصل الاجتماعى</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    @foreach($data['social_media'] as $media)
                                        <tr>
                                            ...
                                            @if($media->social_media)
                                                <td><a style="color: #1b8d39"
                                                       href="{{ $media->social_media->social_link  }}"
                                            ...
                                            <td>
                                                ...
                                                @if($media->social_media)
                                                    ...
                                                    <div class="media-body text-left icon-state">
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                                   {{ $media->social_media->status == 1 ? 'checked' : '' }}
                                                                   onchange="change_status_socialMedia({{ $media->social_media->id }},{{ $media->social_media->status }})"><span
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" novalidate=""
                                                                      action="{{route('edit-SocialMedia',[$media->id,1])}}"
    ...
    <script>
        ...
        function change_status_socialMedia(id, value) {
            if (value == 0) {
                value = 1;
            } else {
                value = 0;
            }
            axios.get('update-status-socialMedia/' + id + '/' + value)
