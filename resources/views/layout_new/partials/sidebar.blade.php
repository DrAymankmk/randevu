    ...
    <div class="sidebar-logo">
        <div>
            ...
            <a href="{{url('index')}}" class="logo logo-normal">
                <img src="{{URL::asset('build/img/logo.png')}}" alt="Logo" style="margin-right:30%;width:60px">
            </a>
                ...
                <a href="javascript:void(0);" class="drop-arrow-none" data-bs-toggle="dropdown" data-bs-auto-close="outside" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <span class="avatar rounded-circle flex-shrink-0 p-2"><img src="{{ Auth::user()->image ?? null }}" alt="img"></span>
                            <div class="ms-2">
                                <h6 class="fs-14 fw-semibold mb-0">{{ Auth::user()->name ?? null }}</h6>
                                <p class="fs-13 mb-0">{{\App\Models\Clinic::app_type_account(\Illuminate\Support\Facades\Auth::user()->app_type) ?? null }}</p>
                            </div>
                        </div>
            ...
            <ul>
                ...
                <li style="display: none">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{{ Request::is('layout-mini', 'layout-hover-view', 'layout-hidden', 'layout-full-width', 'layout-rtl') ? 'active subdrop' : '' }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Request::is('dashboard') ? 'active' : '' }}">
                            <a href="{{ route('admin.dashboard') }}">
                                <i class="ti ti-layout-dashboard"></i><span>@lang('admin.dashboard')</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ Request::is('clinics') ? 'active' : '' }}">
                            <a href="{{ route('clinics') }}">
                                <i class="ti ti-hospital"></i><span>@lang('main.clinics')</span>
                            </a>
                        </li>
...
{{--                        </li>--}}
                        ...
                        <li class="{{ Request::is('appointments-list') ? 'active' : '' }}">
                            <a href="{{ route('appointments-list') }}">
                                <i class="ti ti-user-shield"></i><span>@lang('admin.reception.appointments_list')</span>
                            </a>
                        </li>
                        <li class="{{ Request::is('main-specialties') ? 'active' : '' }}">
                            <a href="{{ route('main-specialties') }}">
                                <i class="ti ti-user-shield"></i><span>@lang('admin.specialties')</span>
                            </a>
                        </li>
                        <li class="{{ Request::is('cities') ? 'active' : '' }}">
                            <a href="{{route('cities')}}">
                                <i class="ti ti-asset"></i><span>@lang('admin.cities')</span>
                            </a>
                        </li>


                        <li class="{{ Request::is('packages.index') ? 'active' : '' }}">
                            <a href="{{ route('packages.index') }}">
                                <i class="ti ti-user-cog"></i><span>@lang('main.packages')</span>
                            </a>
                        </li>

                        <li class="{{ Request::is('notificationsList') ? 'active' : '' }}">
                            <a href="{{route('notificationsList.index')}}">
                                <i class="ti ti-notification"></i><span>@lang('admin.Notifications')</span>
                            </a>
                        </li>



                        <li class="{{ Request::is('activities') ? 'active' : '' }}" style="display: none">
...
{{--                            </a>--}}
{{--                            <ul>--}}
{{--                                <li><a href="{{route('roles.index')}}" class="{{ Request::is('roles-and-permissions', 'permissions') ? 'active' : '' }}">@lang('main.roles_permissions')</a></li>--}}
{{--                                <li><a href="{{route('admin-supervisor')}}" class="{{ Request::is('admin-supervisor') ? 'active' : '' }}">@lang('admin.SuperVisor Management')</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{{ Request::is('income-report', 'expense-report', 'profit-and-loss', 'appointment-report', 'patient-report') ? 'active subdrop' : '' }}">
                                <i class="ti ti-report"></i><span>@lang('main.reports')</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                    ...
                    <ul>
                        <li class="{{ Request::is('complains-box') ? 'active' : '' }}">
                            <a href="{{route('complains-box')}}">
                                <i class="ti ti-message-dots"></i><span>@lang('main.Complaints Box')</span>
                            </a>
                        </li>
