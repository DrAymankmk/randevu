@php use App\Models\AppType; @endphp
@if (!Route::is(['doctor-dashboard', 'doctors-appointments', 'doctors-appointment-details', 'doctors-patient-details',
'online-consultations', 'doctors-schedules', 'doctors-prescriptions', 'doctors-prescription-details', 'doctors-leaves',
'doctors-reviews', 'doctors-profile-settings', 'doctors-password-settings', 'doctors-notification-settings',
'doctors-notifications', 'patient-dashboard', 'patient-appointments', 'patient-appointment-details',
'patients-doctor-details', 'patient-doctors', 'patient-prescriptions', 'patient-prescription-details',
'patient-invoices', 'patient-invoice-details', 'patient-profile-settings', 'patient-password-settings',
'patient-notifications-settings', 'patient-notifications']))
<!-- Search Modal -->
			...
			<div class="card shadow-none mb-0">
				<div class="px-3 py-2 d-flex flex-row align-items-center" id="search-top">
					...
					<button type="button" class="btn p-0" data-bs-dismiss="modal"
						aria-label="Close"><i class="ti ti-x fs-22"></i></button>
				</div>
			</div>
		</div>
	</div>
...
<div class="sidebar" id="sidebar">
		...
		<div>
			...
			<a href="{{url('index')}}" class="logo logo-normal">
				<img src="{{URL::asset('build/img/logo.png')}}" alt="Logo"
					style="margin-right:30%;width:60px">
			</a>
	...
	<div class="sidebar-inner" data-simplebar>
		<div id="sidebar-menu" class="sidebar-menu">
			@if (!Route::is(['doctor-dashboard', 'doctors-appointments',
			'doctors-appointment-details', 'doctors-patient-details', 'online-consultations',
			'doctors-schedules', 'doctors-prescriptions', 'doctors-prescription-details',
			'doctors-leaves', 'doctors-reviews', 'doctors-profile-settings',
			'doctors-password-settings', 'doctors-notification-settings', 'doctors-notifications',
			'patient-dashboard', 'patient-appointments', 'patient-appointment-details',
			'patients-doctor-details', 'patient-doctors', 'patient-prescriptions',
			'patient-prescription-details', 'patient-invoices', 'patient-invoice-details',
			'patient-profile-settings', 'patient-password-settings', 'patient-notifications-settings',
			...
			<div class="sidebar-top shadow-sm p-2 rounded-1 mb-3 dropend">
				<a href="javascript:void(0);" class="drop-arrow-none" data-bs-toggle="dropdown"
					data-bs-auto-close="outside" data-bs-offset="0,22"
					aria-haspopup="false" aria-expanded="false">
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							<span
								class="avatar rounded-circle flex-shrink-0 p-2"><img
							...
							<div class="ms-2">
								...
								<p class="fs-13 mb-0">
									{{\App\Models\Clinic::app_type_account(\Illuminate\Support\Facades\Auth::user()->app_type) ?? null }}
								</p>
							</div>
						</div>
					...
					<div class="p-2">
						<label
							...
							<span class="d-flex align-items-center">
								<span class="me-2"><img
										src="{{URL::asset('build/img/icons/clinic-01.svg')}}"
										alt=""></span>
						...
						<label
							...
							<span class="d-flex align-items-center">
								<span class="me-2"><img
										src="{{URL::asset('build/img/icons/clinic-02.svg')}}"
										alt=""></span>
						...
						<label
							...
							<span class="d-flex align-items-center">
								<span class="me-2"><img
										src="{{URL::asset('build/img/icons/clinic-03.svg')}}"
										alt=""></span>
						...
						<label
							...
							<span class="d-flex align-items-center">
								<span class="me-2"><img
										src="{{URL::asset('build/img/icons/clinic-04.svg')}}"
										alt=""></span>
			...
			<ul>
				<li class="menu-title"><span>@lang('admin.Admin Dashboard')</span></li>
					...
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);"
								...
								<i
									class="ti ti-layout-dashboard"></i><span>Dashboard</span>
							...
							<ul>
								<li><a href="{{url('index')}}"
										...
										Dashboard</a></li>
								<li><a href="{{url('doctor-dashboard')}}">Doctor
										Dashboard</a></li>
								<li><a href="{{url('patient-dashboard')}}">Patient
										Dashboard</a></li>
							</ul>
						</li>
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'contacts', 'email', 'email-reply', 'invoice', 'add-invoices', 'edit-invoices', 'invoice-details', 'todo', 'todo-list', 'notes', 'kanban-view', 'file-manager', 'social-feed', 'search-list') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-apps"></i><span>Applications</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('chat')}}"
										class="{{ Request::is('chat') ? 'active' : '' }}">Chat</a>
								</li>
								...
								<li class="submenu submenu-two">
									<a href="#"
										class="{{ Request::is('invoice', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active subdrop' : '' }}">Invoices<span
											class="menu-arrow inside-submenu"></span></a>
									<ul>
										<li><a href="{{url('invoice')}}"
												class="{{ Request::is('invoice', 'add-invoices', 'edit-invoices') ? 'active' : '' }}">Invoices</a>
										</li>
								...
								<li><a href="{{url('todo')}}"
										class="{{ Request::is('todo', 'todo-list') ? 'active' : '' }}">To
										Do</a></li>
								<li><a href="{{url('notes')}}"
										class="{{ Request::is('notes') ? 'active' : '' }}">Notes</a>
								</li>
								<li><a href="{{url('kanban-view')}}"
										class="{{ Request::is('kanban-view') ? 'active' : '' }}">Kanban
										Board</a></li>
						...
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('layout-mini', 'layout-hover-view', 'layout-hidden', 'layout-full-width', 'layout-rtl') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-layout-sidebar"></i><span>Layouts</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('index')}}"
										class="{{ Request::is('index') ? 'active' : '' }}">Default</a>
								</li>
								<li><a href="{{url('layout-mini')}}"
										class="{{ Request::is('layout-mini') ? 'active' : '' }}">Mini</a>
								</li>
								<li><a href="{{url('layout-hover-view')}}"
										class="{{ Request::is('layout-hover-view') ? 'active' : '' }}">Hover
										View</a></li>
								<li><a href="{{url('layout-hidden')}}"
										class="{{ Request::is('layout-hidden') ? 'active' : '' }}">Hidden</a>
								</li>
								<li><a href="{{url('layout-full-width')}}"
										class="{{ Request::is('layout-full-width') ? 'active' : '' }}">Full
										Width</a></li>
								<li><a href="{{url('layout-rtl')}}"
										class="{{ Request::is('layout-rtl') ? 'active' : '' }}">RTL</a>
								</li>
							</ul>
						</li>
					</ul>
				...
				<li>
					<ul>
						<li class="submenu" style="display: none">
							<a href="javascript:void(0);"
								class="{{ Request::is('doctors', 'doctors-list', 'edit-doctor', 'doctor-details', 'add-doctor', 'doctor-schedule') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-user-plus"></i><span>Doctors</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('doctors')}}"
										class="{{ Request::is('doctors', 'doctors-list', 'edit-doctor') ? 'active' : '' }}">Doctors</a>
								</li>
								<li><a href="{{url('doctor-details')}}"
										class="{{ Request::is('doctor-details') ? 'active' : '' }}">Doctor
										Details</a></li>
								<li><a href="{{url('add-doctor')}}"
										class="{{ Request::is('add-doctor') ? 'active' : '' }}">Add
										Doctor</a></li>
								<li><a href="{{url('doctor-schedule')}}"
										class="{{ Request::is('doctor-schedule') ? 'active' : '' }}">Doctor
										Schedule</a></li>
							</ul>
						</li>
						<li class="{{ Request::is('dashboard') ? 'active' : '' }}">
							<a href="{{ route('admin.dashboard') }}">
								<i
									class="ti ti-layout-dashboard"></i><span>@lang('admin.dashboard')</span>
							</a>
						</li>
						...
						<li class="submenu" style="display: none">
							<a href="javascript:void(0);"
								class="{{ Request::is('appointments', 'appointment-consultations', 'new-appointment', 'appointment-calendar') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-calendar-check"></i><span>Appointments</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('appointments')}}"
										class="{{ Request::is('appointments', 'appointment-consultations') ? 'active' : '' }}">Appointments</a>
								</li>
								<li><a href="{{url('new-appointment')}}"
										class="{{ Request::is('new-appointment') ? 'active' : '' }}">New
										Appointment</a></li>
								<li><a href="{{url('appointment-calendar')}}"
										class="{{ Request::is('appointment-calendar') ? 'active' : '' }}">Calendar</a>
								</li>
							</ul>
						</li>
						...
						{{--                        @php $app_types = AppType::whereIn('id', [2])->get(); @endphp--}}
						{{--                        @foreach($app_types as $app_type)--}}
						{{--                        <li class="{{ Request::is('app-types',$app_type->id) ? 'active' : '' }}">--}}
						{{--                            <a href="{{route('app-types',$app_type->id)}}">--}}
						{{--                                <i class="ti ti-users"></i><span>{{ app()->getLocale() == 'en' ? $app_type->name_en : $app_type->name_ar }}</span>--}}
						{{--                            </a>--}}
						{{--                        </li>--}}
						{{--                        @endforeach--}}

						{{--                        <li class="{{ Request::is('users', 'edit-patient', 'patients-grid') ? 'active' : '' }}">--}}
						{{--                            <a href="{{ route('users') }}">--}}
						{{--                                <i class="ti ti-users"></i><span>@lang('main.users')</span>--}}
						{{--                            </a>--}}
						{{--                        </li>--}}


						<li
							class="{{ Request::is('appointments-list') ? 'active' : '' }}">
						...
						<li
							class="{{ Request::is('notificationsList') ? 'active' : '' }}">
							<a href="{{route('notificationsList.index')}}">
								<i
									class="ti ti-notification"></i><span>@lang('admin.Notifications')</span>
							</a>
						</li>
						...
						<li class="{{ Request::is('activities') ? 'active' : '' }}"
							...
							<a href="{{url('activities')}}">
								<i
									class="ti ti-activity"></i><span>Activities</span>
							</a>
						</li>
				...
				<li style="display: none">
					<ul>
						<li class="{{ Request::is('staffs') ? 'active' : '' }}">
							<a href="{{url('staffs')}}">
								<i
									class="ti ti-users-group"></i><span>Staffs</span>
							</a>
						</li>
						<li
							...
							<a href="{{url('hrm-departments')}}">
								<i
									class="ti ti-building-bank"></i><span>Departments</span>
							</a>
						</li>
						<li
							...
							<a href="{{url('designation')}}">
								<i
									class="ti ti-user-cog"></i><span>Designation</span>
							</a>
						</li>
						<li class="{{ Request::is('attendance') ? 'active' : '' }}">
							<a href="{{url('attendance')}}">
								<i
									class="ti ti-user-check"></i><span>Attendance</span>
							</a>
						</li>
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('leaves', 'leave-type') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-users-minus"></i><span>Leaves</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('leaves')}}"
										class="{{ Request::is('leaves') ? 'active' : '' }}">Leaves</a>
								</li>
						...
						<li class="{{ Request::is('holidays') ? 'active' : '' }}">
							<a href="{{url('holidays')}}">
								<i
									class="ti ti-home-exclamation"></i><span>Holidays</span>
							</a>
						</li>
						<li class="{{ Request::is('payroll') ? 'active' : '' }}">
							<a href="{{url('payroll')}}">
								<i
									class="ti ti-coin"></i><span>Payroll</span>
							</a>
						</li>
					</ul>
				</li>
				<li class="menu-title" style="display: none"><span>Finance & Accounts</span>
				</li>
				<li style="display: none">
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('expenses', 'expense-category') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-credit-card"></i><span>Expenses</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
						...
						<li class="{{ Request::is('income') ? 'active' : '' }}">
							<a href="{{url('income')}}">
								<i
									class="ti ti-coins"></i><span>Income</span>
							</a>
						</li>
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('invoices', 'invoices-details') ? 'active subdrop' : '' }}">
								<i
									class="ti ti-file-invoice"></i><span>Invoices</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
								<li><a href="{{url('invoices')}}"
										class="{{ Request::is('invoices') ? 'active' : '' }}">Invoices</a>
								</li>
								<li><a href="{{url('invoices-details')}}"
										class="{{ Request::is('invoices-details') ? 'active' : '' }}">Invoice
										Details</a></li>
							</ul>
						</li>
						<li class="{{ Request::is('payments') ? 'active' : '' }}">
							<a href="{{url('payments')}}">
								<i
									class="ti ti-cards"></i><span>Payments</span>
							</a>
						</li>
						<li
							...
							<a href="{{url('transactions')}}">
								<i
									class="ti ti-transition-right"></i><span>Transactions</span>
							</a>
						</li>
					</ul>
				</li>
				<li class="menu-title"><span>@lang('main.reports')</span></li>
				<li>
					<ul>
						{{--                        <li class="submenu">--}}
						{{--                            <a href="javascript:void(0);" class="{{ Request::is('roles-and-permissions', 'permissions', 'delete-account-request') ? 'active subdrop' : '' }}">--}}
						{{--                                <i class="ti ti-user"></i><span>@lang('main.roles_permissions')</span>--}}
						{{--                                <span class="menu-arrow"></span>--}}
						{{--                            </a>--}}
						{{--                            <ul>--}}
						{{--                                <li><a href="{{route('roles.index')}}"
						class="{{ Request::is('roles-and-permissions', 'permissions') ? 'active' : '' }}">@lang('main.roles_permissions')</a>
				</li>--}}
				{{--                                <li><a href="{{route('admin-supervisor')}}"
				class="{{ Request::is('admin-supervisor') ? 'active' : '' }}">@lang('admin.SuperVisor
				Management')</a></li>--}}
				{{--                            </ul>--}}
				{{--                        </li>--}}
				<li class="submenu">
					<a href="javascript:void(0);"
						class="{{ Request::is('income-report', 'expense-report', 'profit-and-loss', 'appointment-report', 'patient-report') ? 'active subdrop' : '' }}">
						<i
							class="ti ti-report"></i><span>@lang('main.reports')</span>
						<span class="menu-arrow"></span>
					</a>
					<ul>
						<li><a href="{{ route('reports.index') }}"
								class="{{ Request::is('income-report') ? 'active' : '' }}">@lang('main.reports')</a>
						</li>
						{{--                                <li><a href="{{url('expense-report')}}"
						class="{{ Request::is('expense-report') ? 'active' : '' }}">Expense
						Report</a>
				</li>--}}
				{{--                                <li><a href="{{url('profit-and-loss')}}"
				class="{{ Request::is('profit-and-loss') ? 'active' : '' }}">Profit & Loss</a>
				</li>--}}
				{{--                                <li><a href="{{url('appointment-report')}}"
				class="{{ Request::is('appointment-report') ? 'active' : '' }}">Appointment
				Report</a></li>--}}
				{{--                                <li><a href="{{url('patient-report')}}"
				class="{{ Request::is('patient-report') ? 'active' : '' }}">Patient Report</a>
				</li>--}}
			</ul>
			</li>
			</ul>
			...
			<li style="display: none">
				<ul>
					<li
						class="{{ Request::is('pages', 'add-page', 'edit-page') ? 'active' : '' }}">
						<a href="{{url('pages')}}">
							<i
								class="ti ti-brand-pagekit"></i><span>Pages</span>
						</a>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('add-blog', 'blogs', 'edit-blog', 'blog-details', 'blog-categories', 'blog-comments') ? 'active subdrop' : '' }}">
							<i
								class="ti ti-brand-blogger"></i><span>Blogs</span>
							<span class="menu-arrow"></span>
						</a>
						<ul>
							<li><a href="{{url('add-blog')}}"
									class="{{ Request::is('add-blog') ? 'active' : '' }}">Add
									Blog</a></li>
							<li><a href="{{url('blogs')}}"
									class="{{ Request::is('blogs', 'edit-blog', 'blog-details') ? 'active' : '' }}">Blogs</a>
							</li>
							<li><a href="{{url('blog-categories')}}"
									class="{{ Request::is('blog-categories') ? 'active' : '' }}">Blog
									Categories</a></li>
							<li><a href="{{url('blog-comments')}}"
									class="{{ Request::is('blog-comments') ? 'active' : '' }}">Blog
									Comments</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('countries', 'states', 'cities') ? 'active subdrop' : '' }}">
							<i
								class="ti ti-map-pins"></i><span>Location</span>
							<span class="menu-arrow"></span>
						</a>
						<ul>
					...
					<li class="{{ Request::is('testimonials') ? 'active' : '' }}">
						<a href="{{url('testimonials')}}">
							<i
								class="ti ti-brand-wechat"></i><span>Testimonials</span>
						</a>
					</li>
					<li class="{{ Request::is('faq') ? 'active' : '' }}">
						<a href="{{url('faq')}}">
							<i
								class="ti ti-question-mark"></i><span>FAQ</span>
						</a>
					</li>
				</ul>
			</li>
			<li class="menu-title"><span>@lang('main.Support')</span></li>
			<li>
				<ul>
					<li class="{{ Request::is('complains-box') ? 'active' : '' }}">
						<a href="{{route('complains-box')}}">
							<i class="ti ti-message-dots"></i><span>@lang('main.Complaints
								Box')</span>
						</a>
					</li>
			...
			<li style="display: none">
				<ul>
					<li class="{{ Request::is('starter') ? 'active' : '' }}">
						<a href="{{url('starter')}}">
							<i
								class="ti ti-player-play"></i><span>Starter</span>
						</a>
					</li>
					<li class="{{ Request::is('profile') ? 'active' : '' }}">
						<a href="{{url('profile')}}">
							<i
								class="ti ti-user-circle"></i><span>Profile</span>
						</a>
					</li>
					...
					<li class="{{ Request::is('timeline') ? 'active' : '' }}">
						<a href="{{url('timeline')}}">
							<i
								class="ti ti-timeline-event-text"></i><span>Timeline</span>
						</a>
					</li>
			...
			<li style="display: none">
				<ul>
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('login-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('login-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('login-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);">
							<i
								class="ti ti-file-pencil"></i><span>Register</span>
							<span class="menu-arrow"></span>
						</a>
						<ul>
							<li><a href="{{url('register-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('register-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('register-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('forgot-password-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('forgot-password-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('forgot-password-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('reset-password-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('reset-password-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('reset-password-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('email-verification-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('email-verification-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('email-verification-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);">
							<i class="ti ti-discount-check"></i><span>2 Step
								Verification</span>
							<span class="menu-arrow"></span>
						</a>
						<ul>
							<li><a href="{{url('two-step-verification-cover')}}">Cover</a>
							</li>
							<li><a href="{{url('two-step-verification-illustration')}}">Illustration</a>
							</li>
							<li><a href="{{url('two-step-verification-basic')}}">Basic</a>
							</li>
						</ul>
					</li>
					<li>
					...
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('error-404')}}">404 Error</a>
							</li>
							<li><a href="{{url('error-500')}}">500 Error</a>
							</li>
						</ul>
					</li>
				</ul>
					...
					<li class="submenu">
						...
						<ul>
							<li><a href="{{url('organization-settings')}}"
									class="{{ Request::is('organization-settings') ? 'active' : '' }}">Organization</a>
							</li>
							...
							<li><a href="{{url('seo-setup-settings')}}"
									class="{{ Request::is('seo-setup-settings') ? 'active' : '' }}">SEO
									Setup</a></li>
							<li><a href="{{url('language-settings')}}"
									class="{{ Request::is('language-settings','language-settings2','language-settings3') ? 'active' : '' }}">Language</a>
							</li>
							<li><a href="{{url('maintenance-mode-settings')}}"
									class="{{ Request::is('maintenance-mode-settings') ? 'active' : '' }}">Maintenance
									Mode</a></li>
							<li><a href="{{url('login-and-register-settings')}}"
									class="{{ Request::is('login-and-register-settings') ? 'active' : '' }}">Login
									& Register</a></li>
							<li><a href="{{url('preferences-settings')}}"
									class="{{ Request::is('preferences-settings') ? 'active' : '' }}">Preferences</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('appointment-settings', 'working-hours-settings', 'cancellation-reason-settings') ? 'active subdrop' : '' }}">
						...
						<ul>
							<li><a href="{{url('appointment-settings')}}"
									class="{{ Request::is('appointment-settings') ? 'active' : '' }}">Appointment</a>
							</li>
							<li><a href="{{url('working-hours-settings')}}"
									class="{{ Request::is('working-hours-settings') ? 'active' : '' }}">Working
									Hours</a></li>
							<li><a href="{{url('cancellation-reason-settings')}}"
									class="{{ Request::is('cancellation-reason-settings') ? 'active' : '' }}">Cancellation
									Reason</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('invoice-settings', 'invoice-templates-settings', 'signatures-settings', 'custom-fields-settings') ? 'active subdrop' : '' }}">
						...
						<ul>
							...
							<li><a href="{{url('custom-fields-settings')}}"
									class="{{ Request::is('custom-fields-settings') ? 'active' : '' }}">Custom
									Fields</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('email-settings', 'email-templates-settings', 'sms-gateways-settings', 'sms-templates-settings', 'gdpr-cookies-settings') ? 'active subdrop' : '' }}">
						...
						<ul>
							...
							<li><a href="{{url('email-templates-settings')}}"
									class="{{ Request::is('email-templates-settings') ? 'active' : '' }}">Email
									Templates</a></li>
							<li><a href="{{url('sms-gateways-settings')}}"
									class="{{ Request::is('sms-gateways-settings') ? 'active' : '' }}">SMS
									Gateways</a></li>
							<li><a href="{{url('sms-templates-settings')}}"
									class="{{ Request::is('sms-templates-settings') ? 'active' : '' }}">SMS
									Templates</a></li>
							<li><a href="{{url('gdpr-cookies-settings')}}"
									class="{{ Request::is('gdpr-cookies-settings') ? 'active' : '' }}">GDPR
									Cookies</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('payment-methods-settings', 'bank-accounts-settings', 'tax-rates-settings', 'currencies-settings') ? 'active subdrop' : '' }}">
						...
						<ul>
							<li><a href="{{url('payment-methods-settings')}}"
									class="{{ Request::is('payment-methods-settings') ? 'active' : '' }}">Payment
									Methods</a></li>
							<li><a href="{{url('bank-accounts-settings')}}"
									class="{{ Request::is('bank-accounts-settings') ? 'active' : '' }}">Bank
									Accounts</a></li>
							<li><a href="{{url('tax-rates-settings')}}"
									class="{{ Request::is('tax-rates-settings') ? 'active' : '' }}">Tax
									Rates</a></li>
							<li><a href="{{url('currencies-settings')}}"
									class="{{ Request::is('currencies-settings') ? 'active' : '' }}">Currencies</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('sitemap-settings', 'clear-cache-settings', 'storage-settings', 'cronjob-settings', 'ban-ip-address-settings', 'system-backup-settings', 'database-backup-settings', 'system-update') ? 'active subdrop' : '' }}">
							<i class="ti ti-settings-2"></i><span>Other
								Settings</span>
							<span class="menu-arrow"></span>
						</a>
						<ul>
							<li><a href="{{url('sitemap-settings')}}"
									class="{{ Request::is('sitemap-settings') ? 'active' : '' }}">Sitemap</a>
							</li>
							<li><a href="{{url('clear-cache-settings')}}"
									class="{{ Request::is('clear-cache-settings') ? 'active' : '' }}">Clear
									Cache</a></li>
							<li><a href="{{url('storage-settings')}}"
									class="{{ Request::is('storage-settings') ? 'active' : '' }}">Storage</a>
							</li>
							<li><a href="{{url('cronjob-settings')}}"
									class="{{ Request::is('cronjob-settings') ? 'active' : '' }}">Cronjob</a>
							</li>
							<li><a href="{{url('ban-ip-address-settings')}}"
									class="{{ Request::is('ban-ip-address-settings') ? 'active' : '' }}">Ban
									IP Address</a></li>
							<li><a href="{{url('system-backup-settings')}}"
									class="{{ Request::is('system-backup-settings') ? 'active' : '' }}">System
									Backup</a></li>
							<li><a href="{{url('database-backup-settings')}}"
									class="{{ Request::is('database-backup-settings') ? 'active' : '' }}">Database
									Backup</a></li>
							<li><a href="{{url('system-update')}}"
				...
				<ul>
					<li class="submenu">
						...
						<ul>
							...
							<li><a href="{{url('ui-links')}}"
									class="{{ Request::is('ui-links') ? 'active' : '' }}">Links</a>
							</li>
							<li><a href="{{url('ui-list-group')}}"
									class="{{ Request::is('ui-list-group') ? 'active' : '' }}">List
									Group</a></li>
							...
							<li><a href="{{url('ui-scrollspy')}}"
									class="{{ Request::is('ui-scrollspy') ? 'active' : '' }}">Scrollspy</a>
							</li>
							...
							<li><a href="{{url('ui-utilities')}}"
									class="{{ Request::is('ui-utilities') ? 'active' : '' }}">Utilities</a>
							</li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('extended-dragula', 'ui-clipboard', 'ui-rangeslider', 'ui-sweetalerts', 'ui-lightbox', 'ui-rating', 'ui-scrollbar') ? 'active subdrop' : '' }}">
							<i class="ti ti-radar"></i><span>Advanced
								UI</span><span
								class="menu-arrow"></span>
						</a>
						<ul>
							<li><a href="{{url('extended-dragula')}}"
									class="{{ Request::is('extended-dragula') ? 'active' : '' }}">Dragula</a>
							</li>
					...
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-select2', 'form-wizard', 'form-pickers') ? 'active subdrop' : '' }}">
							<i class="ti ti-forms"></i><span>Forms</span><span
								class="menu-arrow"></span>
						</a>
						<ul>
							<li class="submenu submenu-two">
								<a href="javascript:void(0);"
									class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-mask', 'form-fileupload') ? 'active subdrop' : '' }}">Form
									Elements<span
										class="menu-arrow inside-submenu"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('tables-basic', 'data-tables') ? 'active subdrop' : '' }}">
							<i
								class="ti ti-table-row"></i><span>Tables</span><span
								class="menu-arrow"></span>
						</a>
						<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('chart-apex', 'chart-c3', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity') ? 'active subdrop' : '' }}">
					...
					<li class="submenu">
						<a href="javascript:void(0);"
							class="{{ Request::is('icon-fontawesome', 'icon-tabler', 'icon-bootstrap', 'icon-remix', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicons', 'icon-flag') ? 'active subdrop' : '' }}">
						...
						<ul>
							...
							<li><a href="{{url('icon-weather')}}"
									...
									Icons</a></li>
							<li><a href="{{url('icon-typicons')}}"
									class="{{ Request::is('icon-typicons') ? 'active' : '' }}">Typicons
									Icons</a></li>
				...
				<ul>
					...
					<li>
						<a href="javascript:void(0);"><i
								...
								class="badge bg-danger ms-2 badge-md rounded-2 fs-12 fw-medium">v1.6.7</span></a>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);">
						...
						<ul>
							<li><a href="javascript:void(0);">Multilevel 1</a>
							</li>
							<li class="submenu submenu-two">
								...
								<ul>
									...
									<li
										class="submenu submenu-two submenu-three">
										<a
											href="javascript:void(0);">Multilevel
											2.2<span
							...
							<li><a href="javascript:void(0);">Multilevel 3</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<li class="menu-title"><span>@lang('main.demo-request')</span></li>
			<li>
				<ul>
				</ul>
			...
			<li class="menu-title"><span>@lang('main.cms')</span>
			</li>
			<li>
				<ul>
					...
					<li class="submenu">
						...
						<ul>
							<li><a href="{{route('cms.pages.index')}}"
									class="{{ Request::is('cms-pages') ? 'active' : '' }}">@lang('main.cms-pages')</a>
							</li>
							<li><a href="{{route('cms.pages.builder.create')}}"
									class="{{ Request::is('admin/cms/pages/builder*') ? 'active' : '' }}">@lang('main.cms-page-builder')</a>
							</li>
							<li><a href="{{route('cms.sections.index')}}"
									class="{{ Request::is('cms-sections') ? 'active' : '' }}">@lang('main.cms-sections')</a>
							</li>
							<li><a href="{{route('cms.items.index')}}"
									class="{{ Request::is('cms-items') ? 'active' : '' }}">@lang('main.cms-items')</a>
							</li>
							<li><a href="{{route('cms.links.index')}}"
									class="{{ Request::is('cms-links') ? 'active' : '' }}">@lang('main.cms-links')</a>
							</li>
							<li><a href="{{route('cms.media.index')}}"
									class="{{ Request::is('cms-media') ? 'active' : '' }}">@lang('main.cms-media')</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			'doctors-patient-details', 'online-consultations', 'doctors-schedules',
			'doctors-prescriptions', 'doctors-prescription-details', 'doctors-leaves',
			'doctors-reviews', 'doctors-profile-settings', 'doctors-password-settings',
			'doctors-notification-settings', 'doctors-notifications']))
			<ul style="display: none">
				...
				<li>
					<ul>
						...
						<li
							class="{{ Request::is('doctors-schedules') ? 'active' : '' }}">
							<a href="{{url('doctors-schedules')}}">
								<i class="ti ti-clock-check"></i><span>My
									Schedule</span>
							</a>
						</li>
						<li
							...
							<a href="{{url('doctors-prescriptions')}}">
								<i
									class="ti ti-prescription"></i><span>Prescriptions</span>
							</a>
						</li>
						<li
							class="{{ Request::is('doctors-leaves') ? 'active' : '' }}">
							<a href="{{url('doctors-leaves')}}">
								<i
									class="ti ti-calendar-x"></i><span>Leave</span>
							</a>
						</li>
						<li
							class="{{ Request::is('doctors-reviews') ? 'active' : '' }}">
							<a href="{{url('doctors-reviews')}}">
								<i
									class="ti ti-star"></i><span>Reviews</span>
							</a>
						</li>
						<li class="submenu">
							<a href="javascript:void(0);"
								...
								<i
									class="ti ti-settings"></i><span>Settings</span>
								<span class="menu-arrow"></span>
							</a>
							<ul>
			...
			@if (Route::is(['patient-dashboard', 'patient-appointments',
			'patient-appointment-details', 'patients-doctor-details', 'patient-doctors',
			'patient-prescriptions', 'patient-prescription-details', 'patient-invoices',
			'patient-invoice-details', 'patient-profile-settings', 'patient-password-settings',
			'patient-notifications-settings', 'patient-notifications']))
			<ul style="display: none">
				<li class="menu-title"><span>Main Menu</span></li>
				<li>
					<ul>
						...
						<li
							...
							<a href="{{url('patient-doctors')}}">
								<i
									class="ti ti-stethoscope"></i><span>Doctors</span>
							</a>
						</li>
						<li
						...
						<li
							...
							<a href="{{url('patient-invoices')}}">
								<i
									class="ti ti-star"></i><span>Invoice</span>
							</a>
						</li>
						<li class="submenu">
							<a href="javascript:void(0);"
