        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{url('index')}}" class="logo">
                ...
                <span class="logo-light">
                    ...
                    <span class="logo-sm"><img src="{{URL::asset('build/img/logo-small.png')}}" alt="small logo"></span>
                </span>

                <!-- Logo Dark -->
                <span class="logo-dark">
                    <span class="logo-lg"><img src="{{URL::asset('build/img/logo-white.png')}}" alt="dark logo"></span>
                </span>
            </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{route('clinics')}}" class="btn topbar-link"><i class="ti ti-calendar-due"></i></a>
                    </div>
                </div>
                <!-- Appointment -->
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{route('admin.dashboard')}}" class="btn topbar-link"><i
...
{{--                                    <div class="d-flex">--}}
{{--                                        <div class="me-2 position-relative flex-shrink-0">--}}
{{--                                            <img src="{{URL::asset('build/img/doctors/doctor-06.jpg')}}"--}}
{{--                                                 class="avatar-md rounded-circle" alt="">--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                                    <div class="d-flex">--}}
{{--                                        <div class="me-2 position-relative flex-shrink-0">--}}
{{--                                            <img src="{{URL::asset('build/img/doctors/doctor-02.jpg')}}"--}}
{{--                                                 class="avatar-md rounded-circle" alt="">--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                                    <div class="d-flex">--}}
{{--                                        <div class="me-2 position-relative flex-shrink-0">--}}
{{--                                            <img src="{{URL::asset('build/img/doctors/doctor-07.jpg')}}"--}}
{{--                                                 class="avatar-md rounded-circle" alt="">--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                            </div>--}}
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ Auth::user()->image ?? null }}" width="32"
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="{{ Auth::user()->image ?? null }}" class="rounded-circle" width="42"
                                 height="42" alt="">
                            <div class="ms-2">
                                <p class="fw-medium text-dark mb-0">{{ Auth::user()->name ?? null }}</p>
        ...
        @if (Route::is(['doctor-dashboard', 'doctors-appointments', 'doctors-appointment-details', 'doctors-patient-details', 'online-consultations', 'doctors-schedules', 'doctors-prescriptions', 'doctors-prescription-details', 'doctors-leaves', 'doctors-reviews', 'doctors-profile-settings', 'doctors-password-settings', 'doctors-notification-settings', 'doctors-notifications']))
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{url('doctors-appointments')}}" class="btn topbar-link"><i
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{url('doctors-profile-settings')}}" class="btn topbar-link"><i
                                class="ti ti-settings-2"></i></a>
                    </div>
                </div>
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}" width="32"
                             class="rounded-circle d-flex" alt="user-image">
                        <span class="online text-success"><i
                                class="ti ti-circle-filled d-flex bg-white rounded-circle border border-1 border-white"></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}" class="rounded-circle"
                        ...
                        <!-- Item-->
                        <a href="{{url('doctors-profile-settings')}}" class="dropdown-item">
        ...
        @if (Route::is(['patient-dashboard', 'patient-appointments', 'patient-appointment-details', 'patients-doctor-details', 'patient-doctors', 'patient-prescriptions', 'patient-prescription-details', 'patient-invoices', 'patient-invoice-details', 'patient-profile-settings', 'patient-password-settings', 'patient-notifications-settings', 'patient-notifications']))
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{url('patient-appointments')}}" class="btn topbar-link"><i
                                class="ti ti-calendar-due"></i></a>
                    </div>
                </div>
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{url('patient-profile-settings')}}" class="btn topbar-link"><i
                                class="ti ti-settings-2"></i></a>
                    </div>
                </div>
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="{{URL::asset('build/img/users/user-02.jpg')}}" width="32"
                             class="rounded-circle d-flex" alt="user-image">
                        <span class="online text-success"><i
                                class="ti ti-circle-filled d-flex bg-white rounded-circle border border-1 border-white"></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="{{URL::asset('build/img/users/user-02.jpg')}}" class="rounded-circle" width="42"
                                 height="42" alt="">
                            <div class="ms-2">
                        ...
                        <!-- Item-->
                        <a href="{{url('patient-profile-settings')}}" class="dropdown-item">
                            <i class="ti ti-user-circle me-1 align-middle"></i>
                            <span class="align-middle">Profile Settings</span>
                        </a>
