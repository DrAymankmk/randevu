    ...
    <div class="page-container topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="<?php echo e(url('index')); ?>" class="logo">
                ...
                <span class="logo-light">
                    <span class="logo-lg"><img src="<?php echo e(URL::asset('build/img/logo.png')); ?>" alt="logo"></span>
                    <span class="logo-sm"><img src="<?php echo e(URL::asset('build/img/logo-small.png')); ?>" alt="small logo"></span>
                </span>

                <!-- Logo Dark -->
                <span class="logo-dark">
                    <span class="logo-lg"><img src="<?php echo e(URL::asset('build/img/logo-white.png')); ?>" alt="dark logo"></span>
                </span>
            </a>
        ...
        <?php if(!Route::is(['doctor-dashboard', 'doctors-appointments', 'doctors-appointment-details', 'doctors-patient-details', 'online-consultations', 'doctors-schedules', 'doctors-prescriptions', 'doctors-prescription-details', 'doctors-leaves', 'doctors-reviews', 'doctors-profile-settings', 'doctors-password-settings', 'doctors-notification-settings', 'doctors-notifications', 'patient-dashboard', 'patient-appointments', 'patient-appointment-details', 'patients-doctor-details', 'patient-doctors', 'patient-prescriptions', 'patient-prescription-details', 'patient-invoices', 'patient-invoice-details', 'patient-profile-settings', 'patient-password-settings', 'patient-notifications-settings', 'patient-notifications'])): ?>
            <div class="d-flex align-items-center">
                ...
                <?php if(app()->getLocale() == 'ar'): ?>
                    <a href="<?php echo e(URL::to('changeLanguageAdmin','en')); ?>"
                       class="btn btn-liner-gradient me-3 flag flag-us">
                        EN 🇺🇸
                        <i class="ti ti-world ms-1"></i>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(URL::to('changeLanguageAdmin','ar')); ?>"
                       class="btn btn-liner-gradient me-3 flag flag-eg">
                        AR SA
                        <i class="ti ti-world ms-1"></i>
                    </a>
                <?php endif; ?>
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(route('clinics')); ?>" class="btn topbar-link"><i class="ti ti-calendar-due"></i></a>
                    </div>
                </div>
                <!-- Appointment -->
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn topbar-link"><i
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="<?php echo e(Auth::user()->image ?? null); ?>" width="32"
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="<?php echo e(Auth::user()->image ?? null); ?>" class="rounded-circle" width="42"
                                 height="42" alt="">
                            <div class="ms-2">
                                <p class="fw-medium text-dark mb-0"><?php echo e(Auth::user()->name ?? null); ?></p>
                        ...
                        <div class="pt-2 mt-2 border-top">
                            <a href="<?php echo e(url('admin/login')); ?>" class="dropdown-item text-danger">
        ...
        <?php if(Route::is(['doctor-dashboard', 'doctors-appointments', 'doctors-appointment-details', 'doctors-patient-details', 'online-consultations', 'doctors-schedules', 'doctors-prescriptions', 'doctors-prescription-details', 'doctors-leaves', 'doctors-reviews', 'doctors-profile-settings', 'doctors-password-settings', 'doctors-notification-settings', 'doctors-notifications'])): ?>
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(url('doctors-appointments')); ?>" class="btn topbar-link"><i
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(url('doctors-profile-settings')); ?>" class="btn topbar-link"><i
                                class="ti ti-settings-2"></i></a>
                    </div>
                </div>
                        ...
                        <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                            ...
                            <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                    ...
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/img/doctors/doctor-01.jpg')); ?>"
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                    ...
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/img/doctors/doctor-06.jpg')); ?>"
                                                 class="avatar-md rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 fw-medium text-dark">Dr. Patel</p>
                                            <p class="mb-1 text-wrap">
                                                completed a <span class="fw-medium text-dark">follow-up</span> report
                                                for patient <span class="fw-medium text-dark">Emily</span>.
                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                    ...
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/img/doctors/doctor-02.jpg')); ?>"
                                                 class="avatar-md rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 fw-medium text-dark">Emily</p>
                                            <p class="mb-1 text-wrap">
                                                booked an appointment with <span
                                                    class="fw-medium text-dark">Dr. Patel</span> for <span
                                                    class="fw-medium text-dark">April 15</span>
                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/img/doctors/doctor-07.jpg')); ?>"
                                                 class="avatar-md rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 fw-medium text-dark">Amelia</p>
                                            <p class="mb-1 text-wrap">
                                                completed the <span class="fw-medium text-dark">pre-visit</span> health
                                                questionnaire.
                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                            ...
                            <!-- View All-->
                            <div class="p-2 rounded-bottom border-top text-center">
                                <a href="<?php echo e(url('doctors-notifications')); ?>"
                                   class="text-center text-decoration-underline fs-14 mb-0">
                                    View All Notifications
                                </a>
                            </div>
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="<?php echo e(URL::asset('build/img/doctors/doctor-01.jpg')); ?>" width="32"
                             class="rounded-circle d-flex" alt="user-image">
                        <span class="online text-success"><i
                                class="ti ti-circle-filled d-flex bg-white rounded-circle border border-1 border-white"></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="<?php echo e(URL::asset('build/img/doctors/doctor-01.jpg')); ?>" class="rounded-circle"
                        ...
                        <!-- Item-->
                        <a href="<?php echo e(url('doctors-profile-settings')); ?>" class="dropdown-item">
                        ...
                        <!-- Item-->
                        <div class="pt-2 mt-2 border-top">
                            <a href="<?php echo e(url('login')); ?>" class="dropdown-item text-danger">
                                <i class="ti ti-logout me-1 fs-17 align-middle"></i>
                                <span class="align-middle">Log Out</span>
                            </a>
                        </div>
        ...
        <?php if(Route::is(['patient-dashboard', 'patient-appointments', 'patient-appointment-details', 'patients-doctor-details', 'patient-doctors', 'patient-prescriptions', 'patient-prescription-details', 'patient-invoices', 'patient-invoice-details', 'patient-profile-settings', 'patient-password-settings', 'patient-notifications-settings', 'patient-notifications'])): ?>
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(url('patient-appointments')); ?>" class="btn topbar-link"><i
                                class="ti ti-calendar-due"></i></a>
                    </div>
                </div>
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="<?php echo e(url('patient-profile-settings')); ?>" class="btn topbar-link"><i
                                class="ti ti-settings-2"></i></a>
                    </div>
                </div>
                ...
                <div class="header-item">
                    <div class="dropdown me-3">
                        ...
                        <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                            ...
                            <!-- View All-->
                            <div class="p-2 rounded-bottom border-top text-center">
                                <a href="<?php echo e(url('patient-notifications')); ?>"
                                   class="text-center text-decoration-underline fs-14 mb-0">
                                    View All Notifications
                                </a>
                            </div>
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                       data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="<?php echo e(URL::asset('build/img/users/user-02.jpg')); ?>" width="32"
                             class="rounded-circle d-flex" alt="user-image">
                        <span class="online text-success"><i
                                class="ti ti-circle-filled d-flex bg-white rounded-circle border border-1 border-white"></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            <img src="<?php echo e(URL::asset('build/img/users/user-02.jpg')); ?>" class="rounded-circle" width="42"
                                 height="42" alt="">
                            <div class="ms-2">
                        ...
                        <!-- Item-->
                        <a href="<?php echo e(url('patient-profile-settings')); ?>" class="dropdown-item">
                            <i class="ti ti-user-circle me-1 align-middle"></i>
                            <span class="align-middle">Profile Settings</span>
                        </a>
...
<!-- Topbar End -->
<?php /**PATH C:\xampp\htdocs\Other\randvous\TakafolJoodNew\resources\views/layout_new/partials/header.blade.php ENDPATH**/ ?>