...
<?php if(Route::is(['layout-hidden'])): ?>
<html lang="en" data-layout="hidden">
<?php endif; ?>

<?php if(Route::is(['layout-hover-view'])): ?>
<html lang="en" data-layout="hoverview">
<?php endif; ?>

<?php if(Route::is(['layout-mini'])): ?>
...
<?php if(Route::is(['layout-full-width'])): ?>
<html lang="en" data-layout="full-width">
<?php endif; ?>

<?php echo $__env->make('layout_new.partials.title-meta', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
    ...
    <?php if(Route::is(['login-basic', 'login-illustration', 'login-cover', 'register-basic', 'register-illustration', 'register-cover', 'forgot-password-basic', 'forgot-password-illustration', 'forgot-password-cover', 'reset-password-basic', 'reset-password-illustration', 'reset-password-cover', 'email-verification-basic', 'email-verification-illustration', 'email-verification-cover', 'success-basic', 'success-illustration', 'success-cover', 'two-step-verification-basic', 'two-step-verification-illustration', 'two-step-verification-cover', 'lock-screen', 'error-404', 'error-500'])): ?>
    <div class="main-wrapper auth-bg position-relative overflow-hidden">
    <?php endif; ?>

    <?php if(!Route::is(['login-basic', 'login-illustration', 'login-cover', 'login', 'register-basic', 'register-illustration', 'register-cover', 'forgot-password-basic', 'forgot-password-illustration', 'forgot-password-cover', 'reset-password-basic', 'reset-password-illustration', 'reset-password-cover', 'email-verification-basic', 'email-verification-illustration', 'email-verification-cover', 'success-basic', 'success-illustration', 'success-cover', 'two-step-verification-basic', 'two-step-verification-illustration', 'two-step-verification-cover', 'lock-screen', 'error-404', 'error-500', 'coming-soon', 'under-maintenance'])): ?>
        <?php echo $__env->make('layout_new.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php echo $__env->make('layout_new.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <?php echo $__env->make('layout_new.partials.footer-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\Other\randvous\TakafolJoodNew\resources\views/layout_new/mainlayout.blade.php ENDPATH**/ ?>