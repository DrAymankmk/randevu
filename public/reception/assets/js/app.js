...
// 	document.getElementsByClassName('switchLang')[0].src = '/reception/assets/img/icons/ar.png';
// 	document.getElementsByClassName('switchLang')[1].src = '/reception/assets/img/icons/ar.png';
// 	document.getElementById('breadcrumbArrow').classList.add('feather-chevron-right')
...
// 	document.getElementById('breadcrumbArrow').classList.add(localStorage.getItem('lang') === 'ar' ? 'feather-chevron-left' : 'feather-chevron-right')
// 	// document.getElementsByClassName('switchLang')[0].src = localStorage.getItem('lang') === 'ar' ? '/reception/assets/img/icons/en.png' : '/reception/assets/img/icons/ar.png';
// 	// document.getElementsByClassName('switchLang')[1].src = localStorage.getItem('lang') === 'ar' ? '/reception/assets/img/icons/en.png' : '/reception/assets/img/icons/ar.png';
// }
...
$(document).ready(function($) {
	...
	if($slimScrolls.length > 0) {
		localStorage.getItem('lang') === 'en' ? $slimScrolls.slimScroll({
			height: 'auto',
			width: '100%',
			position: 'right',
			size: '7px',
	...
	if(screen.width >= 992) {
		$(document).on('click', '#toggle_btn', function() {
			if($('body').hasClass('mini-sidebar')) {
				...
				$('div.page-wrapper').removeClass('minimize-content')
				$('.subdrop + ul').slideDown();
			} else {
				$('body').addClass('mini-sidebar');
				$('div.page-wrapper').addClass('minimize-content')
				$('.subdrop + ul').slideUp();
			}
			return false;
		});
	...
	// Small Sidebar In Large Screen
	if ($(document).width() <= 1600 && $(document).width() >= 992) {
		$('body').addClass('mini-sidebar');
		$('div.page-wrapper').addClass('minimize-content')
		$('.subdrop + ul').slideUp();
	}
	window.addEventListener('resize', function(event) {
		if(screen.width <= 1600 && this.screen.width >= 992) {
			$('body').addClass('mini-sidebar');
			$('div.page-wrapper').addClass('minimize-content')
			$('.subdrop + ul').slideUp();
		} else {
